...
export function CaseDetail() {
  ...
  const responses = Array.isArray(c.recommendedResponse) ? c.recommendedResponse : []
  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6">
      ...
      <div className="glass-panel rounded-lg p-4 bg-teal-soft/40 dark:bg-teal/5 border-teal/20 relative overflow-hidden">
        ...
        <p className="text-sm leading-relaxed">{c.lesson?.plainEnglish || 'No summary available.'}</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="glass-panel rounded-lg p-4">
          ...
          <dl className="text-sm space-y-3">
            ...
            <div className="flex justify-between border-b border-border dark:border-border-dark/50 pb-1"><dt className="text-slate">Ports</dt><dd className="font-mono">{ports.length > 0 ? ports.join(', ') : '—'}</dd></div>
        ...
        <div className="glass-panel rounded-lg p-4 border border-warning/30 bg-warning/5 relative overflow-hidden">
          ...
          <ul className="text-sm space-y-2 list-none text-charcoal dark:text-cream mb-4">
            ...
            {responses.length === 0 && <li className="text-slate">No recommended responses.</li>}
          </ul>
      ...
      <div className="glass-panel rounded-lg p-4">
        ...
        <div className="flex flex-col gap-4 relative">
          ...
          {evidence.length === 0 && (
            <div className="text-sm text-slate py-4 pl-6">No evidence items recorded for this case.</div>
          )}
        </div>
      </div>
    </div>
