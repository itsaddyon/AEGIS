...
const BOOT_LOGS = [
  'INITIALIZING ARGUS SUBSYSTEMS...',
  'ESTABLISHING SECURE IPC BRIDGE...',
  'MOUNTING INTRUSION DETECTION ENGINE...',
  'LOADING SNORT/SURICATA RULESETS...',
  'ACTIVATING REAL-TIME TRAFFIC MONITOR...',
  'SYSTEM ONLINE. WELCOME TO ARGUS.'
]

export function SplashPreloader({ onComplete }: { onComplete: () => void }) {
  const targetWord = 'ARGUS'
  const fullForm = 'Advanced Real-time Guardian for Unified Security'
